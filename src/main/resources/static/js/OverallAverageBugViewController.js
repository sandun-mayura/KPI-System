app.controller('OverallAverageBugViewController', function ($scope, $http) {
    ...
    var getGraphDataOverallAverageBug = function () {
    ...
    $scope.showOverallAverageBug = function () {
        getGraphDataOverallAverageBug();
    };

    $scope.showOverallAverageBug();
});
