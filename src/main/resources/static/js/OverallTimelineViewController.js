app.controller('OverallTimelineViewController', function ($scope, $http) {
    ...
    var getGraphDataOverallTimeline = function () {
        ...
        $http.get('/api/calculateView?teamId='+ teamId,{'cache': false}).then(function (response) {
            ...
            zingchart.render({
                ...
                height:'100%',
                width:'100%',
                data: $scope.graphDataOverallTimeline
            });
        });
        });
    ...
    $scope.showOverallTimeline = function () {
        getGraphDataOverallTimeline();
    };

    $scope.showOverallTimeline();
});
